...
Last Modified : 2014 May 17 (Sat) 11:27:20 by Harold Carr.
-}
...
infoRequestTestData = InfoRequest [ "phphotoLakeZurichAtDusk"
                                  , "phphotoWinterSunII"
                                  , "phphotoQuoVadis"
                                  , "phphotoDock3"
                                  , "phphotoZueriWest"
...
shortenRequestTestData = ShortenRequest "https://www.example.com/" Nothing
...
makeRequestUrlTests = TestList
    ...
    ,teq "makeRequestUrl expand"     (makeRequestUrl (ExpandRequest ["u1","u2"] ["h1"]))
